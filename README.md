...
[![GitHub Stars](https://img.shields.io/github/stars/chris-cpz/strategy-pppp?style=for-the-badge&logo=github)](https://github.com/chris-cpz/strategy-pppp)
...
```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-pppp.git
cd strategy-pppp
...
```python
from strategy import ppppStrategy

# Initialize strategy
strategy = ppppStrategy()
...
- **Documentation**: [Wiki](https://github.com/chris-cpz/strategy-pppp/wiki)
- **Issues**: [GitHub Issues](https://github.com/chris-cpz/strategy-pppp/issues)
- **Discussions**: [GitHub Discussions](https://github.com/chris-cpz/strategy-pppp/discussions)
